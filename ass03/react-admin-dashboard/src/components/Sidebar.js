...
import PeopleOutlinedIcon from "@mui/icons-material/PeopleOutlined"; // For Users
  ...
  return (
    ...
    >
      ...
      <Box pl={isCollapsed ? undefined : "10%"}>
          ...
          <Typography variant="h6" sx={{ m: "15px 0 5px 20px" }}>Management</Typography>
          ...
          <Item title="Kanban Board" to="/kanban" icon={<MapOutlinedIcon />} selected={selected} setSelected={setSelected} />
